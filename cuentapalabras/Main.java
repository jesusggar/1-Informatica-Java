...
import java.util.NoSuchElementException; import java.io.PrintWriter;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            contadorSigFich.leeFicheroNoSig("practica42/fichNoSig.txt", delimitadores);
        ...
        try {
            contador.incluyeTodasFichero("practica42/datos.txt", delimitadores);
            contadorSigFich.incluyeTodasFichero("practica42/datos.txt", delimitadores);
            System.out.println(contador + "\n");
            ...
            //métodos para presentar por pantalla para No Significativas System.out.println();
            contadorSigFich.presentaPalabras(pw);
            //salida a fichero contadorSigFich.presentaPalabras("salidaNoSig.txt");
        } catch (IOException e) {
            System.out.println("ERROR:" + e.getMessage());
        }
    }
